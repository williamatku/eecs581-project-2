...
SHIP2 = pygame.image.load('images/shipImages/shipSize1.png')
SHIP3 = pygame.image.load('images/shipImages/shipSize1.png')
SHIP4 = pygame.image.load('images/shipImages/shipSize1.png')
SHIP5 = pygame.image.load('images/shipImages/shipSize1.png')
